...
describe('treasury', function () {
  ...
  //   }
  // })
  test.each(models)('tx_treasury_proposeSpend_normal', async function (m) {
  ...
  test.each(models)('tx_treasury_proposeSpend_expert', async function (m) {
    const blob_treasury_proposeSpend = ''
    const sim = new Zemu(m.path)
    try {
      await sim.start({ ...defaultOptions, model: m.name })
...
test.each(models)('tx_treasury_spend_normal', async function (m) {
  ...
  test.each(models)('tx_treasury_spend_expert', async function (m) {
    const blob_treasury_spend = ''
    const sim = new Zemu(m.path)
    try {
      await sim.start({ ...defaultOptions, model: m.name })
