...
case 6677: /* module 26 call 21 pallet:democracy call:remove_other_vote */
       ...
       break;
case 6679: /* module 26 call 23 pallet:democracy call:blacklist */
...
case 6656: /* module 26 call 00 pallet:democracy call:propose */
       switch (itemIdx) {
       case 0: /* democracy_propose_V1 - proposal */;
           return _toStringBoundedCallOfT(
               &m->nested.democracy_propose_V1.proposal,
               outValue, outValueLen,
               pageIdx, pageCount);
...
case 6660: /* module 26 call 04 pallet:democracy call:external_propose */
       switch (itemIdx) {
       case 0: /* democracy_external_propose_V1 - proposal */;
           return _toStringBoundedCallOfT(
               &m->nested.democracy_external_propose_V1.proposal,
               outValue, outValueLen,
               pageIdx, pageCount);
       default:
           return parser_no_data;
...
case 6661: /* module 26 call 05 pallet:democracy call:external_propose_majority */
       switch (itemIdx) {
       case 0: /* democracy_external_propose_majority_V1 - proposal */;
           return _toStringBoundedCallOfT(
               &m->nested.democracy_external_propose_majority_V1.proposal,
               outValue, outValueLen,
               pageIdx, pageCount);
       default:
           return parser_no_data;
...
case 6662: /* module 26 call 06 pallet:democracy call:external_propose_default */
       switch (itemIdx) {
       case 0: /* democracy_external_propose_default_V1 - proposal */;
           return _toStringBoundedCallOfT(
               &m->nested.democracy_external_propose_default_V1.proposal,
               outValue, outValueLen,
               pageIdx, pageCount);
       default:
           return parser_no_data;
