...
__Z_INLINE parser_error_t _readMethod_elections_change_members_V1(
    parser_context_t* c, pd_elections_change_members_V1_t* m)
{
    ...
    pd_Method_V1_t* method)
{
    ...
    case 3072: /* module 12 call 0 */
        CHECK_ERROR(_readMethod_elections_change_members_V1(c, &method->basic.elections_change_members_V1))
        break;
    ...
    uint8_t pageIdx, uint8_t* pageCount)
{
    ...
    case 3072: /* module 12 call 0 */
        switch (itemIdx) {
        case 0: /* elections_change_members_V1 - members */;
            return _toStringVecAccountId_V1(
                &m->basic.elections_change_members_V1.members,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
